import {
  ...
  nip57_exports,
  relayInit
} from "./chunk-NTKBTMJK.js";
import {
  require_dist
} from "./chunk-L6OI7FI7.js";
import {
  schnorr
} from "./chunk-3AXIJSEU.js";
import {
  sha256
...
import {
  require_browser
} from "./chunk-YHHW6MXK.js";
import {
  bech32
} from "./chunk-AEPGJMKL.js";
import {
  require_bolt11
} from "./chunk-IDQHBKYT.js";
import {
  require_lib
} from "./chunk-J6FOMVUI.js";
import {
  __publicField,
  __toESM
...
function getWriteRelaysFor(ndk, author) {
  ...
  if (!ndk.outboxTracker)
    return void 0;
  return (_a = ndk.outboxTracker.data.get(author)) == null ? void 0 : _a.writeRelays;
}
  ...
  if (subIds.length > 0) {
    ...
    for (const filter of filters) {
      for (const key of Object.keys(filter)) {
        if (key === "kinds") {
          (_a = filter.kinds) == null ? void 0 : _a.forEach((k) => filterKinds.add(k));
        } else {
...
function calculateRelaySetFromEvent(ndk, event) {
  var _a;
  const relays = /* @__PURE__ */ new Set();
  (_a = ndk.pool) == null ? void 0 : _a.permanentAndConnectedRelays().forEach((relay) => relays.add(relay));
...
function verifySignature(persist) {
  ...
  try {
    if ((_a = this.ndk) == null ? void 0 : _a.asyncSigVerification) {
...
var NDKZap = class _NDKZap extends import_tseep4.EventEmitter {
  constructor(args) {
    ...
    this.zappedUser = args.zappedUser || this.ndk.getUser({ pubkey: (_a = this.zappedEvent) == null ? void 0 : _a.pubkey });
  }
  /**
  ...
  relays() {
    var _a, _b;
    let r = [];
    if ((_b = (_a = this.ndk) == null ? void 0 : _a.pool) == null ? void 0 : _b.relays) {
...
var NDKEvent = class _NDKEvent extends import_tseep.EventEmitter {
  ...
  async toNostrEvent(pubkey) {
    ...
    if (!pubkey && this.pubkey === "") {
      const user = await ((_b = (_a = this.ndk) == null ? void 0 : _a.signer) == null ? void 0 : _b.user());
  ...
  async sign(signer) {
    var _a;
    if (!signer) {
      (_a = this.ndk) == null ? void 0 : _a.assertSigner();
      signer = this.ndk.signer;
    } else {
  ...
  async publish(relaySet, timeoutMs) {
    ...
    if (this.kind === 5 && ((_a = this.ndk.cacheAdapter) == null ? void 0 : _a.deleteEvent)) {
  ...
  async generateTags() {
    ...
    if ((((_a = this.ndk) == null ? void 0 : _a.clientName) || ((_b = this.ndk) == null ? void 0 : _b.clientNip89)) && !this.tagValue("client")) {
  ...
  muted() {
    var _a, _b;
    const authorMutedEntry = (_a = this.ndk) == null ? void 0 : _a.mutedIds.get(this.pubkey);
  ...
  referenceTags(marker, skipAuthorTag, forceTag) {
    ...
    if ((_a = this.relay) == null ? void 0 : _a.url) {
      tags = tags.map((tag) => {
        var _a2;
        tag.push((_a2 = this.relay) == null ? void 0 : _a2.url);
        return tag;
      });
    } else if (marker) {
      tags = tags.map((tag) => {
...
var NDKSubscription = class extends import_tseep5.EventEmitter {
  ...
  isGroupable() {
    var _a;
    return ((_a = this.opts) == null ? void 0 : _a.groupable) || false;
  }
  shouldQueryCache() {
    var _a;
    return ((_a = this.opts) == null ? void 0 : _a.cacheUsage) !== "ONLY_RELAY";
  }
  shouldQueryRelays() {
    var _a;
    return ((_a = this.opts) == null ? void 0 : _a.cacheUsage) !== "ONLY_CACHE";
  }
  shouldWaitForCache() {
    var _a;
    return (
      ...
      !!((_a = this.ndk.cacheAdapter) == null ? void 0 : _a.locking) && // If explicitly told to run in parallel, then
  ...
  hasAuthorsFilter() {
    return this.filters.some((f) => {
      var _a;
      return (_a = f.authors) == null ? void 0 : _a.length;
    });
  }
  async startWithCache() {
    var _a;
    if ((_a = this.ndk.cacheAdapter) == null ? void 0 : _a.query) {
  ...
  eventReceived(event, relay, fromCache = false) {
    ...
    if (!fromCache) {
      ...
      if (((_a = event.relay) == null ? void 0 : _a.shouldValidateEvent()) !== false) {
  ...
  eoseReceived(relay) {
    ...
    const hasSeenAllEoses = this.eosesSeen.size === ((_a = this.relayFilters) == null ? void 0 : _a.size);
      ...
      if (this.eosesSeen.size >= 2 && percentageOfRelaysThatHaveSentEose >= 0.5) {
        ...
        const sendEoseTimeout = () => {
          ...
          if (lastEventSeen !== void 0 && lastEventSeen < 20) {
            ...
            this.emit("eose");
            if ((_a2 = this.opts) == null ? void 0 : _a2.closeOnEose)
              this.stop();
          }
        };
        this.eoseTimeout = setTimeout(sendEoseTimeout, timeToWaitForNextEose);
...
async function follows(opts, outbox, kind = 3) {
  ...
  if (contactListEvent) {
    ...
    if (outbox) {
      (_b = (_a = this.ndk) == null ? void 0 : _a.outboxTracker) == null ? void 0 : _b.trackUsers(Array.from(pubkeys));
    }
...
var NDKUser = class _NDKUser {
  ...
  async getZapConfiguration(ndk) {
    ...
    const process = async () => {
      var _a, _b, _c, _d;
      if ((_b = (_a = this.ndk) == null ? void 0 : _a.cacheAdapter) == null ? void 0 : _b.loadUsersLNURLDoc) {
...
var NDKHighlight = class _NDKHighlight extends NDKEvent {
  ...
  get context() {
    var _a;
    return ((_a = this.tags.find(([tag, value]) => tag === "context")) == null ? void 0 : _a[1]) ?? void 0;
  }
  /**
  ...
  async getArticle() {
    ...
    if (taggedBech32) {
      let a = await ((_a = this.ndk) == null ? void 0 : _a.fetchEvent(taggedBech32));
      if (a) {
        if (a.kind === 30023) {
          a = NDKArticle.from(a);
        }
...
var NDKRelayList = class _NDKRelayList extends NDKEvent {
  ...
  static async forUsers(pubkeys, ndk) {
    ...
    if ((_a = ndk.cacheAdapter) == null ? void 0 : _a.locking) {
...
var NDKSubscriptionStart = class _NDKSubscriptionStart extends NDKEvent {
  ...
  get recipient() {
    var _a;
    const pTag = (_a = this.getMatchingTags("p")) == null ? void 0 : _a[0];
    if (!pTag)
      return void 0;
  ...
  get amount() {
    var _a;
    const amountTag = (_a = this.getMatchingTags("amount")) == null ? void 0 : _a[0];
    if (!amountTag)
      return void 0;
  ...
  get tierId() {
    var _a, _b;
    const eTag = (_a = this.getMatchingTags("e")) == null ? void 0 : _a[0];
  ...
  async fetchTier() {
    ...
    if (!tierId)
      return void 0;
    const e = await ((_a = this.ndk) == null ? void 0 : _a.fetchEvent(tierId));
    if (!e)
      return void 0;
...
var NDKSubscriptionReceipt = class _NDKSubscriptionReceipt extends NDKEvent {
  ...
  get tierName() {
    var _a;
    const tag = (_a = this.getMatchingTags("tier")) == null ? void 0 : _a[0];
  ...
  get validPeriod() {
    var _a;
    const tag = (_a = this.getMatchingTags("valid")) == null ? void 0 : _a[0];
    if (!tag)
      return void 0;
    try {
      return {
  ...
  get startPeriod() {
    var _a;
    return (_a = this.validPeriod) == null ? void 0 : _a.start;
  }
  get endPeriod() {
    var _a;
    return (_a = this.validPeriod) == null ? void 0 : _a.end;
  }
  /**
...
var NDKNip07Signer = class {
  ...
  async relays() {
    var _a, _b;
    await this.waitForExtension();
    const relays = await ((_b = (_a = window.nostr).getRelays) == null ? void 0 : _b.call(_a)) || {};
    const activeRelays = [];
...
var GetPublicKeyHandlingStrategy = class {
  async handle(backend, id, remotePubkey, params) {
    var _a;
    return (_a = backend.localUser) == null ? void 0 : _a.pubkey;
  }
};
...
function addRelays(event, relays) {
  ...
  const tags = [];
  if (!relays || relays.length === 0) {
    const poolRelays = (_a = event.ndk) == null ? void 0 : _a.pool.relays;
...
var NDKPool = class extends import_tseep11.EventEmitter {
  ...
  addRelay(relay, connect = true) {
    ...
    const isBlacklisted = (_a = this.blacklistRelayUrls) == null ? void 0 : _a.has(relay.url);
    ...
    relay.on("delayed-connect", (delay) => {
      var _a2;
      if ((_a2 = this.ndk.cacheAdapter) == null ? void 0 : _a2.updateRelayStatus) {
...
var NDK = class extends import_tseep9.EventEmitter {
  ...
  set activeUser(user) {
    var _a;
    const differentUser = ((_a = this._activeUser) == null ? void 0 : _a.pubkey) !== (user == null ? void 0 : user.pubkey);
  ...
  subscribe(filters, opts, relaySet, autoStart = true) {
    ...
    if (this.outboxPool && subscription.hasAuthorsFilter()) {
      const authors = subscription.filters.filter((filter) => {
        var _a2;
        return filter.authors && ((_a2 = filter.authors) == null ? void 0 : _a2.length) > 0;
      }).map((filter) => filter.authors).flat();
      (_a = this.outboxTracker) == null ? void 0 : _a.trackUsers(authors);
    }
    if (autoStart) {
